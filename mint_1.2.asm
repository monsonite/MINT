; *************************************************************************
;
;        MINT_1.2 Micro-Interpreter for the Z80 based on SIMPL
;
;        Ken Boak July 2021
;
...
begin_:                         ; Left parentesis begins a loop
            ...
            POP  HL
            LD  (loopcount), HL ; Preserve the Loop counter
            LD  DE,loopstart    ; Loop code is copied to buffer at loopstart 

loopbyte:   INC BC              ; Point to next character
            LD A, (BC)          ; Get the next character
            CP $29              ; Is it a right bracket $29
            JR z, end_loop      ; end the code copy
            LD (DE), A          ; store the character at the CFA
            INC DE
