...
mint_7 is the latest upload.  On the RC2014 Micro it loads at address $8000.
...
2.  A text buffer area beginning at $8800 and further storage for the User's definitions

3.  A vector table beginning at $9040 which allocates a code field address (CFA) to each of the primitive and user defined functions. The vector table is 192 bytes long, which allocates 2 byte addresses for each of the 96 functions.
