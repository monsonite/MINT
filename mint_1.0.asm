; *************************************************************************
;
;        MINT_1.0 micro-interpreter based on SIMPL
;
;        Ken Boak July 2021
;
...
;
;        Minor typo fixed in crlf routine
;		 Prints "OK" when it quits back to the monitor
;        The instruction pointer BC is preserved before entering the 
;		 print stack "dot" routine and restored at the end of that routine
;
;
;        New in version 1.0
;
;        User Definitions using : and ;
;
;
...
;		 :     DEF     Begin a User Definition
;		 ;     RET     End a User Definition
;
;
